...
PAGES['home'] = {
    ...
    <section class="hero" id="hero">
        ...
        <div class="hero-content">
            <div class="hero-badge"><span class="hero-badge-dot"></span><span>Admissions Open 2026-27</span></div>
...
PAGES['sports'] = {
    ...
    <section class="section"><div class="container">
        ...
        <div class="houses-grid">
            <div class="house-card stagger" data-tilt><div class="house-color" style="background:#e74c3c"></div><h4>🔴 Kalam House</h4><p>Courage & Determination</p></div>
            <div class="house-card stagger" data-tilt><div class="house-color" style="background:#3498db"></div><h4>🔵 Raman House</h4><p>Wisdom & Loyalty</p></div>
            <div class="house-card stagger" data-tilt><div class="house-color" style="background:#2ecc71"></div><h4>🟢 Tagore House</h4><p>Growth & Harmony</p></div>
            <div class="house-card stagger" data-tilt><div class="house-color" style="background:#f39c12"></div><h4>🟡 Teresa House</h4><p>Energy & Excellence</p></div>
        </div>
    </div></section>`
};
...
PAGES['gallery'] = {
    ...
    <section class="section"><div class="container">
        ...
        <div class="gallery-grid">
            <div class="gallery-item stagger" data-category="campus" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#667eea,#764ba2)"><span class="gallery-emoji">🏫</span><span class="gallery-label">School Campus</span></div></div>
            <div class="gallery-item stagger" data-category="sports" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#f093fb,#f5576c)"><span class="gallery-emoji">⚽</span><span class="gallery-label">Sports Day</span></div></div>
            <div class="gallery-item stagger" data-category="events" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#4facfe,#00f2fe)"><span class="gallery-emoji">🎉</span><span class="gallery-label">Annual Function</span></div></div>
            <div class="gallery-item stagger" data-category="academics" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#43e97b,#38f9d7)"><span class="gallery-emoji">🔬</span><span class="gallery-label">Science Lab</span></div></div>
            <div class="gallery-item stagger" data-category="campus" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#fa709a,#fee140)"><span class="gallery-emoji">📚</span><span class="gallery-label">Library</span></div></div>
            <div class="gallery-item stagger" data-category="sports" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#a18cd1,#fbc2eb)"><span class="gallery-emoji">🏊</span><span class="gallery-label">Swimming</span></div></div>
            <div class="gallery-item stagger" data-category="events" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#ffecd2,#fcb69f)"><span class="gallery-emoji">🎭</span><span class="gallery-label">Cultural Program</span></div></div>
            <div class="gallery-item stagger" data-category="academics" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#a1c4fd,#c2e9fb)"><span class="gallery-emoji">💻</span><span class="gallery-label">Computer Lab</span></div></div>
        </div>
    </div></section>`
};
