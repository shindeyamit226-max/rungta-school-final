...
PAGES['gallery'] = {
    ...
    <section class="section"><div class="container">
        ...
        <div class="gallery-grid">
            <div class="gallery-item stagger" data-category="campus" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#1b3a6b,#0f2347)"><span class="gallery-emoji">🏫</span><span class="gallery-label">School Campus</span></div></div>
            <div class="gallery-item stagger" data-category="sports" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#c8a84e,#a07830)"><span class="gallery-emoji">⚽</span><span class="gallery-label">Sports Day</span></div></div>
            <div class="gallery-item stagger" data-category="events" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#2a5298,#1b3a6b)"><span class="gallery-emoji">🎉</span><span class="gallery-label">Annual Function</span></div></div>
            <div class="gallery-item stagger" data-category="academics" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#2e7d32,#1b5e20)"><span class="gallery-emoji">🔬</span><span class="gallery-label">Science Lab</span></div></div>
            <div class="gallery-item stagger" data-category="campus" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#c8a84e,#e0c068)"><span class="gallery-emoji">📚</span><span class="gallery-label">Library</span></div></div>
            <div class="gallery-item stagger" data-category="sports" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#1b3a6b,#2a5298)"><span class="gallery-emoji">🏊</span><span class="gallery-label">Swimming</span></div></div>
            <div class="gallery-item stagger" data-category="events" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#c8a84e,#a07830)"><span class="gallery-emoji">🎭</span><span class="gallery-label">Cultural Program</span></div></div>
            <div class="gallery-item stagger" data-category="academics" data-tilt><div class="gallery-placeholder" style="background:linear-gradient(135deg,#2a5298,#1b3a6b)"><span class="gallery-emoji">💻</span><span class="gallery-label">Computer Lab</span></div></div>
        </div>
    </div></section>`
};
